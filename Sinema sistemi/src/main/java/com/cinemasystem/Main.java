...
public class Main {
    ...
    public static void ornekVeriEkle(BiletSistemi biletSistemi) {
        ...
        var film2 = new Film("Oppenheimer", "Gerilim", 180, "Christopher Nolan");
        ...
        var musteri1 = new Musteri("fırat", "Aktif", "firatcihan@hotmail.com", "5555555555");
        var musteri2 = new Musteri("ibrahim", "Pasif", "ibrahimcihan@hotmail.com", "5666666666");
